...
public class Imagen extends javax.swing.JFrame {
    ...
    public Imagen(Integer id) {
       ...
       try {
           ...
           var cro =  crasRepository.findById(id);
           byte[] imagen = Base64.decodeBase64(cro.getCarsImages().getImage());
           ImageIcon imageIcon = new ImageIcon(imagen);

           imageIcon.setImage(imageIcon.getImage().getScaledInstance(this.jLabel1.getWidth(),this.jLabel1.getHeight(),1));

           this.jLabel1.setIcon(imageIcon);
       }catch (Exception e){
           this.setVisible(false);
           JOptionPane.showMessageDialog(this, "Este carro não possui imagens.");
